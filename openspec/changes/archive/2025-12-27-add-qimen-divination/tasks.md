...
- [x] 1.1 创建目录结构 `src/services/qimen/`
- [x] 1.2 编写 `types.ts` 类型定义
...
- [x] 1.3 编写 `data/constants.ts` 常量数据
...
- [x] 4.1 实现 `SanQiLiuYiCalculator.ts`
  - 计算天盘干布局
  - 根据时干确定起点
  - 处理中宫寄宫逻辑
- [x] 4.2 编写三奇六仪单元测试
...
- [x] 9.1 实现 `GeJuCalculator.ts`
  - 识别吉格（三奇得使、九遁等）
  - 识别凶格（入墓、击刑等）
- [x] 9.2 添加约 20-30 种基础格局规则
- [x] 9.3 编写格局判断单元测试

## 10. 渲染器

- [x] 10.1 创建 `src/output/qimenTextRenderer.ts`
  - 基本信息渲染
  - 九宫格 ASCII 艺术渲染
  - 旬首信息渲染
  - 格局列表渲染
...
- [x] 11.2 添加 Zod Schema 定义
  ...
  ```
- [x] 11.3 在 tools 数组中注册 `qimen_basic` 工具
  - 工具名称和描述
  - inputSchema 绑定
- [x] 11.4 实现 Handler
  - 参数验证
  ...
  - 调用 renderQimenText()
  - 返回 MCP 标准格式
- [x] 11.5 编写 MCP 工具集成测试

## 12. 文档和验证

- [x] 12.1 更新 README.md 添加奇门遁甲说明
- [x] 12.2 添加使用示例
- [x] 12.3 创建 OpenSpec 测试规范文档 (test-spec.md)
- [x] 12.4 完整功能验收测试
- [x] 12.5 与现有术数服务对比验证
